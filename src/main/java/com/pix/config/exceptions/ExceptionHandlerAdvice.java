...
import com.pix.config.exceptions.dto.ApiErrorDTO;
import com.pix.config.exceptions.dto.ErrorDTO;
...
public class ExceptionHandlerAdvice {
    ...
    public ResponseEntity<ApiErrorDTO> handlerHttpMessageNotReadableException(HttpMessageNotReadableException exception) {
